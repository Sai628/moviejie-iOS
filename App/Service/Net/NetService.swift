...
class NetService
{
    ...
    {
        NetHelper.get(APIAddress.API_DOMAIN + movieLink, values: nil, cacheResult: true, onError: onError, onFailure: onFailure) { (jsonObject) in
    ...
    {
        NetHelper.get(APIAddress.API_DOMAIN + link, values: nil, cacheResult: true, onError: onError, onFailure: onFailure) { (jsonObject) in
    ...
    {
        NetHelper.get(APIAddress.API_DOMAIN + ostLink, values: nil, cacheResult: true, onError: onError, onFailure: onFailure) { (jsonObject) in
